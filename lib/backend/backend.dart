...
import 'schema/journalentries_collection_record.dart';
...
import 'schema/manageclients_record.dart';
import 'schema/plans_record.dart';
import 'schema/tasks_record.dart';
import 'schema/recording_record.dart';
import 'schema/recentactivity_record.dart';
...
export 'schema/journalentries_collection_record.dart';
...
export 'schema/manageclients_record.dart';
export 'schema/plans_record.dart';
export 'schema/tasks_record.dart';
export 'schema/recording_record.dart';
export 'schema/recentactivity_record.dart';
...
/// Functions to query JournalentriesCollectionRecords (as a Stream and as a Future).
Future<int> queryJournalentriesCollectionRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      JournalentriesCollectionRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<JournalentriesCollectionRecord>>
    queryJournalentriesCollectionRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<JournalentriesCollectionRecord>>
    queryJournalentriesCollectionRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<JournalentriesCollectionRecord>>
    queryJournalentriesCollectionRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, JournalentriesCollectionRecord>
      controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
        queryCollectionPage(
          ...
          if (isStream) {
            final streamSubscription = (page.dataStream)
                ?.listen((List<JournalentriesCollectionRecord> data) {
              data.forEach((item) {
                final itemIndexes = controller.itemList!
                    .asMap()
                    .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query ManageclientsRecords (as a Stream and as a Future).
Future<int> queryManageclientsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ManageclientsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ManageclientsRecord>> queryManageclientsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ManageclientsRecord.collection,
      ManageclientsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ManageclientsRecord>> queryManageclientsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ManageclientsRecord>> queryManageclientsRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, ManageclientsRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      ManageclientsRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<ManageclientsRecord> data) {
          data.forEach((item) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query RecordingRecords (as a Stream and as a Future).
Future<int> queryRecordingRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RecordingRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RecordingRecord>> queryRecordingRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RecordingRecord.collection,
      RecordingRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RecordingRecord>> queryRecordingRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<RecordingRecord>> queryRecordingRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, RecordingRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      RecordingRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<RecordingRecord> data) {
          data.forEach((item) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
...
/// Functions to query RecentactivityRecords (as a Stream and as a Future).
Future<int> queryRecentactivityRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      RecentactivityRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<RecentactivityRecord>> queryRecentactivityRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      RecentactivityRecord.collection,
      RecentactivityRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<RecentactivityRecord>> queryRecentactivityRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<RecentactivityRecord>> queryRecentactivityRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, RecentactivityRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      RecentactivityRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<RecentactivityRecord> data) {
          data.forEach((item) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
