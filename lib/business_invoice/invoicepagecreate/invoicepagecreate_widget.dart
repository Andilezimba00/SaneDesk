...
import 'invoicepagecreate_model.dart';
export 'invoicepagecreate_model.dart';
...
class InvoicepagecreateWidget extends StatefulWidget {
  const InvoicepagecreateWidget({
    super.key,
    this.invoiceCount,
  });

  final List<InvoicesRecord>? invoiceCount;

  static String routeName = 'invoicepagecreate';
  static String routePath = '/invoicepagecreate';

  @override
  State<InvoicepagecreateWidget> createState() =>
      _InvoicepagecreateWidgetState();
}

class _InvoicepagecreateWidgetState extends State<InvoicepagecreateWidget>
    with TickerProviderStateMixin {
  late InvoicepagecreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvoicepagecreateModel());
