...
import '/business_invoice/noinvoices/noinvoices_widget.dart';
...
import 'invoicepag_e_model.dart';
export 'invoicepag_e_model.dart';

/// list of invoices with due date and whether it has been paid or not
                    ...
                    children: [
                      StreamBuilder<List<ClientsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ClientsRecord> textClientsRecordList =
                              snapshot.data!;
                          ...
                          return InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              if ((textClientsRecordList.isNotEmpty) == false) {
                                return;
                              }
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          context.pushNamed(
                            InvoicepagecreateWidget.routeName,
                            extra: <String, dynamic>{
                              '__transition_info__': TransitionInfo(
                                hasTransition: true,
                        ...
                        itemBuilder: (context, listViewIndex) {
                          ...
                          return StreamBuilder<ClientsRecord>(
                            stream: ClientsRecord.getDocument(
                                listViewInvoicesRecord.clientRef!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                              ...
                              return InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                    InvoicedetailsCopyWidget.routeName,
                                    queryParameters: {
                                      'invoicedoc': serializeParam(
                                        listViewInvoicesRecord,
                                        ParamType.Document,
                                      ),
                                    }.withoutNulls,
                                    extra: <String, dynamic>{
                                      'invoicedoc': listViewInvoicesRecord,
                                    },
                                  );
                                },
                                child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  Text(
                                                    'Invoice#  ${listViewInvoicesRecord.invoiceNumber.toString()}',
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'Client:${containerClientsRecord.businessName}',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
